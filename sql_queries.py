...
create_table_queries = [user_table_create, song_table_create, artist_table_create, time_table_create, song_staging_table_create,log_staging_table_create,songplay_table_create]
